...
class TextFrame(Subshape):
    ...
    def fit_text(
        ...
        font_size = self._best_fit_font_size(
            font_family, max_size, bold, italic, font_file, features, spacing	# drw
        )
        self._apply_fit(font_family, font_size, bold, italic)
        return font_size	# drw
    ...
    def _best_fit_font_size(self, family, max_size, bold, italic, font_file, features, spacing):
        """
        ...
        *italic*. If *font_file* is specified, it is used to calculate the
        ...
        return TextFitter.best_fit_font_size(
            self.text, self._extents, max_size, font_file, features, spacing	# drw: added features
        )
